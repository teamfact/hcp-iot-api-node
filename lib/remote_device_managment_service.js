...
function RemoteDeviceManagementService(account, password) {

  this._host = "https://iotrdmsiotservices-" + account + "trial.hanatrial.ondemand.com";
...
RemoteDeviceManagementService.prototype.setHost = function(host) {
  this._host = url;
}
...
RemoteDeviceManagementService.prototype.registerDevice = function(data, token) {
...
module.exports = RemoteDeviceManagementService;
